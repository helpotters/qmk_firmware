...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT(KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_GRV, KC_ESC, KC_TAB, KC_W, KC_F, KC_P, KC_G, KC_J, KC_L, KC_U, KC_Y, KC_SCLN, KC_BSPC, KC_TAB, KC_A, KC_R, KC_LPRN, KC_LCBR, KC_D, KC_H, KC_RCBR, KC_RPRN, KC_I, KC_O, KC_QUOT, KC_LSFT, KC_LSFT, KC_X, KC_C, KC_V, KC_B, KC_MUTE, KC_NO, KC_K, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_LGUI, KC_LALT, KC_LGUI, KC_TRNS, KC_BSPC, KC_ENT, KC_TRNS, KC_RCTL, KC_RALT, KC_RGUI),
